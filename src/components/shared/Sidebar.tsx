...
const linkClasses = "flex intems-center gap-2 font-light px-3 py-2 hover:bg-neutral-700 hover:no-underline active:bg-neutral-600 rounded-sm text-base";
...
const SidebarLink = ({ item }: linkItem) => {
